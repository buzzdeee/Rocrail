...
RocProDlgGen::RocProDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_SaveCV = new wxToggleButton( this, wxID_ANY, wxT("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer5->Add( m_SaveCV, 0, wxRIGHT|wxLEFT, 5 );
	...
	m_SaveCV->Connect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( RocProDlgGen::onSaveCV ), NULL, this );
...
RocProDlgGen::~RocProDlgGen()
{
	...
	m_SaveCV->Disconnect( wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler( RocProDlgGen::onSaveCV ), NULL, this );
