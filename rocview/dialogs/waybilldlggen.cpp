...
waybillgen::waybillgen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_labOrigin->Wrap( -1 );
	fgSizer1->Add( m_labOrigin, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	...
	fgSizer1->Add( m_Origin, 0, wxEXPAND|wxALL, 5 );
	...
	fgSizer1->Add( m_labDestination, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	...
	fgSizer1->Add( m_Destination, 0, wxEXPAND|wxALL, 5 );
	...
	m_Cartype = new wxComboBox( m_GeneralPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_DROPDOWN|wxCB_READONLY ); 
	...
	m_Routing = new wxTextCtrl( m_RoutingPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );
	bSizer5->Add( m_Routing, 1, wxALL|wxEXPAND, 5 );
	...
	m_Copy->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( waybillgen::OnCopy ), NULL, this );
	...
	m_stdButtonHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( waybillgen::onHelp ), NULL, this );
...
waybillgen::~waybillgen()
{
	...
	m_Copy->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( waybillgen::OnCopy ), NULL, this );
	...
	m_stdButtonHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( waybillgen::onHelp ), NULL, this );
