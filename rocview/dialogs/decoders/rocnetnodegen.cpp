...
rocnetnodegen::rocnetnodegen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer23->Add( m_SecAck, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	fgSizer8->Add( m_ADCSensor, 0, wxBOTTOM|wxRIGHT|wxLEFT|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_labADCThreshold = new wxStaticText( m_OptionsPanel, wxID_ANY, wxT("Threshold:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labADCThreshold->Wrap( -1 );
	fgSizer8->Add( m_labADCThreshold, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	m_ADCThreshold = new wxSpinCtrl( m_OptionsPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 255, 0 );
	fgSizer8->Add( m_ADCThreshold, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT, 5 );
	
	bSizer23->Add( fgSizer8, 0, 0, 5 );
	
	wxString m_IOTypeChoices[] = { wxT("I2C-1"), wxT("I2C-0"), wxT("I2C-2") };
	...
	bSizer23->Add( m_IOType, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	bSizer23->Add( m_DCCType, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	bSizer17->Add( m_DCCDevice, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	bSizer17->Add( m_TraceLevelsBox, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	...
	m_StdButtonHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( rocnetnodegen::onHelp ), NULL, this );
...
rocnetnodegen::~rocnetnodegen()
{
	...
	m_StdButtonHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( rocnetnodegen::onHelp ), NULL, this );
