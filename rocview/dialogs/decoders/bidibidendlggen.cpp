...
BidibIdentDlgGen::BidibIdentDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_Tree = new wxTreeCtrl( m_IndexPanel, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), wxTR_DEFAULT_STYLE|wxTR_SINGLE|wxSUNKEN_BORDER );
	m_Tree->SetMinSize( wxSize( 250,-1 ) );
	...
	bSizer21->Add( m_BiDiBlogo, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_VID = new wxTextCtrl( m_IndexPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), 0 );
	fgSizer16->Add( m_VID, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_VIDD = new wxTextCtrl( m_IndexPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), 0 );
	...
	m_PID = new wxTextCtrl( m_IndexPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), wxTE_READONLY );
	fgSizer17->Add( m_PID, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_PIDD = new wxTextCtrl( m_IndexPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxTE_READONLY );
	fgSizer17->Add( m_PIDD, 0, wxALL, 5 );
	...
	fgSizer8->Add( m_labUsername, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_labUID = new wxStaticText( m_IndexPanel, wxID_ANY, wxT("UID"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labUID->Wrap( -1 );
	fgSizer18->Add( m_labUID, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_labVersion->Wrap( -1 );
	fgSizer18->Add( m_labVersion, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_Version = new wxTextCtrl( m_IndexPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_CENTRE|wxTE_READONLY );
	fgSizer18->Add( m_Version, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	bSizer23->Add( fgSizer18, 0, 0, 5 );
	
	m_Pict = new wxStaticBitmap( m_IndexPanel, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( -1,-1 ), 0 );
	bSizer23->Add( m_Pict, 0, wxALL, 5 );
	...
	bSizer4->Add( m_Report, 0, wxALL, 5 );
	...
	m_labIID->Wrap( -1 );
	fgSizer3->Add( m_labIID, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_FeatureBox = new wxStaticBoxSizer( new wxStaticBox( m_FeaturesPanel, wxID_ANY, wxT("Feature") ), wxVERTICAL );
	
	wxFlexGridSizer* fgSizer181;
	fgSizer181 = new wxFlexGridSizer( 0, 4, 0, 0 );
	...
	fgSizer181->Add( m_labFeatureValue, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	fgSizer181->Add( m_FeatureValue, 0, wxALL, 5 );
	
	m_FeatureBox->Add( fgSizer181, 0, wxEXPAND, 5 );
	...
	m_FeatureBox->Add( bSizer71, 0, wxALIGN_RIGHT, 5 );
	
	bSizer9->Add( m_FeatureBox, 0, wxEXPAND, 5 );
	
	m_VendorCVBox = new wxStaticBoxSizer( new wxStaticBox( m_FeaturesPanel, wxID_ANY, wxT("Vendor CV") ), wxVERTICAL );
	...
	m_labVendorCVName = new wxStaticText( m_FeaturesPanel, wxID_ANY, wxT("Name"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labVendorCVName->Wrap( -1 );
	fgSizer19->Add( m_labVendorCVName, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_VendorCVName = new wxTextCtrl( m_FeaturesPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer19->Add( m_VendorCVName, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_labVendorCVValue = new wxStaticText( m_FeaturesPanel, wxID_ANY, wxT("Value"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labVendorCVValue->Wrap( -1 );
	fgSizer19->Add( m_labVendorCVValue, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_VendorCVValue = new wxTextCtrl( m_FeaturesPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer19->Add( m_VendorCVValue, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_VendorCVBox->Add( fgSizer19, 0, wxEXPAND, 5 );
	
	wxBoxSizer* bSizer24;
	bSizer24 = new wxBoxSizer( wxHORIZONTAL );
	
	m_VendorCVEnable = new wxButton( m_FeaturesPanel, wxID_ANY, wxT("Enable"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer24->Add( m_VendorCVEnable, 0, wxALL, 5 );
	
	m_VendorCVDisable = new wxButton( m_FeaturesPanel, wxID_ANY, wxT("Disable"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer24->Add( m_VendorCVDisable, 0, wxALL, 5 );
	
	m_VendorCVGet = new wxButton( m_FeaturesPanel, wxID_ANY, wxT("Get"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer24->Add( m_VendorCVGet, 0, wxALL, 5 );
	
	m_VendorCVSet = new wxButton( m_FeaturesPanel, wxID_ANY, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer24->Add( m_VendorCVSet, 0, wxALL, 5 );
	
	m_VendorCVBox->Add( bSizer24, 0, wxALIGN_RIGHT, 5 );
	
	bSizer9->Add( m_VendorCVBox, 0, wxEXPAND, 5 );
	...
	m_AccessoryOptionsBox = new wxStaticBoxSizer( new wxStaticBox( m_AccessoryPanel, wxID_ANY, wxT("Options") ), wxVERTICAL );
	...
	m_AccessoryOptionsBox->Add( fgSizer12, 0, 0, 5 );
	...
	m_AccessoryOptionsBox->Add( fgSizer13, 0, 0, 5 );
	
	bSizer20->Add( m_AccessoryOptionsBox, 0, wxEXPAND|wxTOP, 5 );
	...
	wxString m_PortTypeChoices[] = { wxT("Standard"), wxT("Light"), wxT("Servo"), wxT("Sound"), wxT("Motor"), wxT("Analog"), wxT("Macro"), wxT("Backlight") };
	...
	m_labPortNumber = new wxStaticText( m_ServoPanel, wxID_ANY, wxT("Number"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labPortNumber->Wrap( -1 );
	fgSizer21->Add( m_labPortNumber, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_ServoPort = new wxSpinCtrl( m_ServoPanel, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 127, 0 );
	fgSizer21->Add( m_ServoPort, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	m_PortBox->Add( fgSizer21, 0, 0, 5 );
	
	m_PortIOConfigBox = new wxStaticBoxSizer( new wxStaticBox( m_ServoPanel, wxID_ANY, wxT("Config") ), wxVERTICAL );
	
	wxString m_PortIOSelectionChoices[] = { wxT("output"), wxT("high pulse"), wxT("low pulse"), wxT("tristate"), wxT("pullup"), wxT("pulldown") };
	int m_PortIOSelectionNChoices = sizeof( m_PortIOSelectionChoices ) / sizeof( wxString );
	m_PortIOSelection = new wxRadioBox( m_ServoPanel, wxID_ANY, wxT("I/O"), wxDefaultPosition, wxDefaultSize, m_PortIOSelectionNChoices, m_PortIOSelectionChoices, 3, wxRA_SPECIFY_ROWS );
	...
	m_labPortTimer = new wxStaticText( m_ServoPanel, wxID_ANY, wxT("Timer"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labPortTimer->Wrap( -1 );
	fgSizer22->Add( m_labPortTimer, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	m_PortTimer = new wxSpinCtrl( m_ServoPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 1000, 0 );
	...
	bSizer46->Add( m_ServoGet, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	m_PortSet = new wxButton( m_ServoPanel, wxID_ANY, wxT("Set"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer46->Add( m_PortSet, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( BidibIdentDlgGen::onClose ) );
	...
	m_ProductName->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( BidibIdentDlgGen::onProductName ), NULL, this );
	m_UsernameSet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onUsernameSet ), NULL, this );
	m_Pict->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( BidibIdentDlgGen::onProductName ), NULL, this );
	m_Report->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onReport ), NULL, this );
	...
	m_VendorCVEnable->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVEnable ), NULL, this );
	m_VendorCVDisable->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVDisable ), NULL, this );
	m_VendorCVGet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVGet ), NULL, this );
	m_VendorCVSet->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVSet ), NULL, this );
	...
	m_stdButtonsHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onHelp ), NULL, this );
...
{
	// Disconnect Events
	this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( BidibIdentDlgGen::onClose ) );
	...
	m_ProductName->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( BidibIdentDlgGen::onProductName ), NULL, this );
	m_UsernameSet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onUsernameSet ), NULL, this );
	m_Pict->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( BidibIdentDlgGen::onProductName ), NULL, this );
	m_Report->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onReport ), NULL, this );
	...
	m_VendorCVEnable->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVEnable ), NULL, this );
	m_VendorCVDisable->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVDisable ), NULL, this );
	m_VendorCVGet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVGet ), NULL, this );
	m_VendorCVSet->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onVendorCVSet ), NULL, this );
	...
	m_stdButtonsHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( BidibIdentDlgGen::onHelp ), NULL, this );
