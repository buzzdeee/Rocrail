...
ThrottleDlgGen::ThrottleDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxSize( 240,300 ), wxSize( -1,320 ) );
	...
	m_BinState = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,25 ), wxTE_CENTRE|wxTE_NO_VSCROLL|wxTE_PROCESS_ENTER );
	m_BinState->SetMaxLength( 5 ); 
