...
stagedlggen::stagedlggen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_Index = new wxPanel( m_Notebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer71;
	bSizer71 = new wxBoxSizer( wxVERTICAL );
	
	m_StageList = new wxListCtrl( m_Index, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_HRULES|wxLC_REPORT|wxLC_SINGLE_SEL );
	bSizer71->Add( m_StageList, 1, wxALL|wxEXPAND, 5 );
	
	wxBoxSizer* bSizer81;
	bSizer81 = new wxBoxSizer( wxHORIZONTAL );
	
	m_IndexNew = new wxButton( m_Index, wxID_ANY, wxT("New"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer81->Add( m_IndexNew, 0, wxALL, 5 );
	
	m_IndexDelete = new wxButton( m_Index, wxID_ANY, wxT("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer81->Add( m_IndexDelete, 0, wxALL, 5 );
	
	bSizer71->Add( bSizer81, 0, 0, 5 );
	
	m_Index->SetSizer( bSizer71 );
	m_Index->Layout();
	bSizer71->Fit( m_Index );
	m_Notebook->AddPage( m_Index, wxT("Index"), false );
	...
	m_TrainGap = new wxSpinCtrl( m_General, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 999, 0 );
	...
	m_labRandomRate = new wxStaticText( m_General, wxID_ANY, wxT("RandomRate"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labRandomRate->Wrap( -1 );
	fgSizer6->Add( m_labRandomRate, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );
	
	m_RandomRate = new wxSpinCtrl( m_General, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 1000, 0 );
	fgSizer6->Add( m_RandomRate, 0, wxALL, 5 );
	...
	fgSizer5->Add( m_labOwnSectionLength, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	m_OwnSectionLength = new wxSpinCtrl( m_Sections, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 120,-1 ), wxSP_ARROW_KEYS, 0, 1000, 0 );
	fgSizer5->Add( m_OwnSectionLength, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	m_labMinOcc = new wxStaticText( m_Details, wxID_ANY, wxT("Min. occupancy"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labMinOcc->Wrap( -1 );
	fgSizer51->Add( m_labMinOcc, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_MinOcc = new wxSpinCtrl( m_Details, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer51->Add( m_MinOcc, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_SuitsWell = new wxCheckBox( m_Details, wxID_ANY, wxT("Best choice"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer51->Add( m_SuitsWell, 0, wxALL, 5 );
	
	m_InAtLen = new wxCheckBox( m_Details, wxID_ANY, wxT("IN event on train length"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer51->Add( m_InAtLen, 0, wxALL, 5 );
	
	m_UseWD = new wxCheckBox( m_Details, wxID_ANY, wxT("Watchdog"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer51->Add( m_UseWD, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	wxString m_WaitTypeChoices[] = { wxT("Random"), wxT("Fixed"), wxT("Loco"), wxT("None") };
	...
	m_RandomMin = new wxSpinCtrl( m_Details, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 1, 1000, 1 );
	...
	fgSizer7->Add( m_labRandomMax, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	m_RandomMax = new wxSpinCtrl( m_Details, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 1, 10000, 10 );
	fgSizer7->Add( m_RandomMax, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	m_labFixed = new wxStaticText( m_Details, wxID_ANY, wxT("Fixed"), wxDefaultPosition, wxDefaultSize, 0 );
	m_labFixed->Wrap( -1 );
	fgSizer7->Add( m_labFixed, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	m_Fixed = new wxSpinCtrl( m_Details, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 100,-1 ), wxSP_ARROW_KEYS, 1, 1000, 10 );
	fgSizer7->Add( m_Fixed, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	bSizer61->Add( fgSizer7, 1, wxEXPAND, 5 );
	
	m_WaitBox->Add( bSizer61, 1, wxEXPAND, 5 );
	
	bSizer5->Add( m_WaitBox, 0, wxEXPAND|wxALL, 5 );
	...
	fgSizer71->Add( m_ArriveSpeedPercent, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxRIGHT, 5 );
	...
	wxString m_ExitSpeedChoices[] = { wxT("min"), wxT("mid"), wxT("cruise"), wxT("max"), wxT("%") };
	...
	m_ExitSpeed->SetSelection( 3 );
	fgSizer8->Add( m_ExitSpeed, 0, wxALL, 5 );
	
	m_DepartSpeedPercent = new wxSpinCtrl( m_Details, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 80,-1 ), wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer8->Add( m_DepartSpeedPercent, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxRIGHT, 5 );
	
	m_SpeedBox->Add( fgSizer8, 0, 0, 5 );
	
	bSizer5->Add( m_SpeedBox, 0, wxEXPAND|wxALL, 5 );
	
	m_Details->SetSizer( bSizer5 );
	m_Details->Layout();
	bSizer5->Fit( m_Details );
	m_Notebook->AddPage( m_Details, wxT("Details"), false );
	...
	// Connect Events
	m_StageList->Connect( wxEVT_COMMAND_LIST_COL_CLICK, wxListEventHandler( stagedlggen::onStageColumn ), NULL, this );
	m_StageList->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( stagedlggen::onStageList ), NULL, this );
	m_IndexNew->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onIndexNew ), NULL, this );
	m_IndexDelete->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onIndexDelete ), NULL, this );
	...
	m_stdButtonApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnApply ), NULL, this );
	m_stdButtonCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnCancel ), NULL, this );
	m_stdButtonHelp->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnHelp ), NULL, this );
...
{
	// Disconnect Events
	m_StageList->Disconnect( wxEVT_COMMAND_LIST_COL_CLICK, wxListEventHandler( stagedlggen::onStageColumn ), NULL, this );
	m_StageList->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( stagedlggen::onStageList ), NULL, this );
	m_IndexNew->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onIndexNew ), NULL, this );
	m_IndexDelete->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::onIndexDelete ), NULL, this );
	...
	m_stdButtonApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnApply ), NULL, this );
	m_stdButtonCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnCancel ), NULL, this );
	m_stdButtonHelp->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( stagedlggen::OnHelp ), NULL, this );
